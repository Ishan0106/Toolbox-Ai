...
const Story = () => {
    ...
    useEffect(() => {
        setQuestion(`${input}. Generate a short story of 300 words based on the above text.`);
    }, [input]);
    ...
    return (
        ...
        >
            ...
            <form onSubmit={generateAnswer}>
                <Typography variant="h3">Provide a text to generate a short story</Typography>
