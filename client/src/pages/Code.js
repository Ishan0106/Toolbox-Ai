...
const Code = () => {
    ...
    useEffect(() => {
        setQuestion(`${input}. Generate coding logic for the above problem statement.`);
    }, [input]);
    ...
    return (
        ...
        >
            ...
            <form onSubmit={generateAnswer}>
                <Typography variant="h3">Provide a problem statement for generating coding logic</Typography>
